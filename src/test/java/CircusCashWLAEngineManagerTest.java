...
public class CircusCashWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(CircusCashWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/CircusCashWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/CircusCashWLAIW/InitOutcome.xml").getDocumentElement();
